...
class Car:
    ...
    def __init__(self, network, track, image, batch):
        ...
        self.smallest_edge_distance = 100 # пиксели

    def update(self, delta_time):
        render_speed = delta_time * 60
        self.speed -= 0.05 # разногласие
        if self.is_running:
    ...
    def hit_checkpoint(self, id):
        ...
        elif id < self.last_checkpoint_passed: # движение в неправильном направлении или финиш
            self.shut_off()
